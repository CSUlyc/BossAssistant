...
| 界面 | 截图 |
| --- | --- |
| **设置中心**：自我介绍、关键词、城市、HR 活跃、每日上限、简历资料、回复风格 | ![设置页](./docs/images/配置设置.png) |
| **投递控制台**：运行状态、处理数、新投递/跳过/失败数、岗位结果、操作日志 | ![投递控制台](./docs/images/投递控制台.png) |
| **投递记录**：日期筛选、自动刷新、新投递/已沟通统计、CSV 导出 | ![投递记录](./docs/images/投递记录.png) |
| **回复助手**：HR 问题识别、问题类型分类、回复草稿生成、复制/填入 | ![回复助手](./docs/images/回复助手.png) |
